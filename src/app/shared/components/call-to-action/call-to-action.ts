    ...
    <app-container id="linkedin">
      <div class="mx-auto max-w-2xl text-center space-y-7">
        <div class="w-full">
          ...
          <p class="mx-auto mt-4 max-w-xl text-base/7 text-pretty text-gray-600">
        ...
        <a
          ...
          class="text-static-200"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="size-4 fill-static-200">
            <path
